        ...
        >
            ...
            <div className="relative z-10 h-full flex items-end pb-24 md:pb-32 px-6 md:px-16 lg:px-24">
                <div className="max-w-4xl">
                    <p className="hero-subtitle text-primary-400 font-mono text-sm md:text-base tracking-widest uppercase mb-4">
                        Comptabilité automatique &bull; Scoring de crédit
                    </p>

                    <h1 className="hero-title-main font-serif text-5xl md:text-7xl lg:text-8xl font-light text-surface-50 leading-tight">
                        NEXUS
                    </h1>
                    <h2 className="hero-title-italic font-serif italic text-3xl md:text-5xl lg:text-6xl font-light text-primary-300/90 leading-snug mt-2 max-w-3xl">
                        — La mémoire qui te rend
                        <span className="text-primary-400 font-medium"> finançable</span>
                    </h2>

                    <p className="hero-subtitle text-surface-300 mt-6 max-w-xl text-base md:text-lg leading-relaxed">
                    ...
                    <div className="hero-cta flex flex-wrap gap-4 mt-8">
                        <Link
                            to="/signup"
                            className="btn-magnetic px-8 py-4 bg-primary-500 text-surface-950 font-semibold rounded-full text-base"
                        >
                        ...
                        <a
                            href="#features"
                            className="btn-magnetic px-8 py-4 border border-surface-500/40 text-surface-200 font-medium rounded-full text-base"
                        >
                            <span className="btn-bg bg-surface-800 rounded-full" />
                            Découvrir
                        </a>
                    </div>
                </div>
            ...
            <div className="hero-indicator absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2">
                <span className="text-surface-500 text-xs tracking-widest uppercase">Défiler</span>
                <div className="w-5 h-8 border-2 border-surface-500 rounded-full flex justify-center">
                    <div className="w-1 h-2 bg-primary-400 rounded-full mt-2 animate-bounce" />
                </div>
            </div>
        </section>
    );
